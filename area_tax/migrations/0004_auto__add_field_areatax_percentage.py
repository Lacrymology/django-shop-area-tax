...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AreaTax.percentage'
        db.add_column('area_tax_areatax', 'percentage', self.gf('django.db.models.fields.DecimalField')(default='0.0', max_digits=7, decimal_places=6), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AreaTax.percentage'
        db.delete_column('area_tax_areatax', 'percentage')


    models = {
        'area_tax.areatax': {
            'Meta': {'ordering': "('country', 'area')", 'unique_together': "(('country', 'area'),)", 'object_name': 'AreaTax'},
